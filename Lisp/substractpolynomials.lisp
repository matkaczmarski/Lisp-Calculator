...
(defun SubstractPolynomialsM (p1 p2)
...
Wymagania: skladniki wielomianow posortowane rosnaco wzgledem stopnia poteg"
	...
	(cond ((eq nil comp1)
		  ...
		  ((= (GetPower comp1) (GetPower comp2))
			(cons (list `(- ,(GetFactor comp1) ,(GetFactor comp2)) (GetPower comp1)) (SubstractPolynomialsM (rest p1) (rest p2))))
		  ((< (GetPower comp1) (GetPower comp2))
			(cons comp1 (SubstractPolynomialsM (rest p1) p2)))
		  ((> (GetPower comp1) (GetPower comp2))
			(cons (list (* -1 (GetFactor comp2)) (GetPower comp2)) (SubstractPolynomialsM p1 (rest p2)))))))
